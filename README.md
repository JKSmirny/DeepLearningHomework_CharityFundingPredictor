...
Using your knowledge of Pandas and the Scikit-Learn’s `StaDeep_Learning HomeworkndardScaler()`, you’ll need to preprocess the dataset in order to compile, train, and evaluate the neural network model later in Step 2
